...
using Microsoft.AspNetCore.SignalR.NetClient.Http;
using Microsoft.AspNetCore.SignalR.NetClient.Infrastructure;
using Microsoft.AspNetCore.SignalR.NetClient.Transports;
...
namespace Microsoft.AspNetCore.SignalR.NetClient
{
    ...
    public class Connection : IConnection, IDisposable
    {
        ...
        private Task Negotiate(IClientTransport transport)
        {
            ...
            return TaskAsyncHelper.ContinueWithNotComplete(TaskAsyncHelper.Then(transport.Negotiate(this, _connectionData), negotiationResponse =>
                            {
        ...
        {
            return TaskAsyncHelper.Then(TaskAsyncHelper.RunSynchronously(_transport.Start(this, _connectionData, _disconnectCts.Token), () =>
                             {
...
#elif NET451
            request.UserAgent = CreateUserAgentString("SignalR.Client.NET451");
#endif
        ...
        private static IDisposable SetTimeout(TimeSpan delay, Action operation)
        {
            ...
            TaskAsyncHelper.Then(TaskAsyncHelper.Delay(delay), () => cancellableInvoker.Invoke(operation));
