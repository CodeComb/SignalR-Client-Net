...
namespace Microsoft.AspNetCore.SignalR.NetClient.Tests
{
    public class ConnectionTests : IDisposable
    {
        ...
        public void ConnectionStateChangedEventIsCalledWithAppropriateArguments()
        {
            ...
            Assert.True(((IConnection)connection).ChangeState(ConnectionState.Disconnected, ConnectionState.Connecting));
        }
        ...
        private class UrlInspectingHttpClient : IHttpClient
        {
            ...
            public Task<IResponse> Post(string url, Action<IRequest> prepareRequest, System.Collections.Generic.IDictionary<string, string> postData, bool isLongRunning)
            {
                throw new NotImplementedException();
            }
        }
