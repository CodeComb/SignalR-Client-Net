...
namespace Microsoft.AspNetCore.SignalR.NetClient.Tests.Infrastructure
{
    public class TransportInitializationHandlerTests
    {
        [Fact]
        ...
        public void FailInvokedIfDisconnectTokenTripped()
        {
            ...
            Assert.Equal(Resources.Error_ConnectionCancelled, (string) exception.Message);
